...
% Variables
\newcommand{\thesisTitle}{Uncovering Insights: Maritime Shipping's Carbon Footprint}
\newcommand{\thesisSubtitle}{Assessing the State of Carbon Dioxide Emissions in Maritime Shipping Through Big Data Analysis}
\newcommand{\authorName}{Freddy Thobhani}
